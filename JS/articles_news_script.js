...
function handleArticles() {
    // Get the number of articles in the Articles array
    let size = Articles.length;
    console.log(size);

    // Loop through each article and generate HTML content
    for (let i = 0; i < size; i++) {
        let article = Articles[i];
        console.log(article);
        console.log(article.IMG);

        // Append the generated HTML content to the 'card-container' element
